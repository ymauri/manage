...
class BeginBill {
     ...
     * @var integer
     *
     * @ORM\Column(name="s20", type="integer", nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="s10", type="integer", nullable=true)
     */
    private $s10;
     ...
     * @var integer
     *
     * @ORM\Column(name="s5", type="integer", nullable=true)
     */
    private $s5;
     ...
     * @var integer
     *
     * @ORM\Column(name="s2", type="integer", nullable=true)
     */
    private $s2;
     ...
     * @var integer
     *
     * @ORM\Column(name="s1", type="integer", nullable=true)
     */
    private $s1;
     ...
     * @var integer
     *
     * @ORM\Column(name="s050", type="integer", nullable=true)
     */
    private $s050;
     ...
     * @var integer
     *
     * @ORM\Column(name="s020", type="integer", nullable=true)
     */
    private $s020;
     ...
     * @var integer
     *
     * @ORM\Column(name="s010", type="integer", nullable=true)
     */
    private $s010;
     ...
     * @var boolean
     *
     * @ORM\Column(name="hascash", type="boolean", nullable=true)
     */
    private $hascash;
    ...
    public function setHascash($hascash)
    {
        $this->hascash = $hascash;
        return $this;
    }
    public function getHascash()
    {
        return $this->hascash;
    }
