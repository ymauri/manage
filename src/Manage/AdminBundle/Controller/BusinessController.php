...
use Manage\AdminBundle\Entity\Business;
use Manage\AdminBundle\Form\BusinessType;
...
class BusinessController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:Business')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminBundle:Business:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Business')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdminBundle:Business:edit.html.twig")
     */
